...
def do_gain(
    files, ref_level=89, force=False, dry_run=False, album=True, mp3_format=None
):
...
def rgain_options():
    ...
    opts.set_description(
        "Apply or display Replay Gain information for audio "
